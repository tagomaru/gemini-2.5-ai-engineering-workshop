...
> [!NOTE]
> I recommend going through the notebooks and exercises in order. You'll find solutions in the [solutions](./solutions/) folder.
...
- Understanding available models and pricing
- **Key Skills**: Environment setup, authentication, model selection
...
- **Final Exercise**: Chat with a book using file upload
...
- **Final Exercise**: Create a multimodal content analyzer
...
- **Final Exercise**: Build an intelligent research assistant with tools
...
- Connecting to remote services and data sources
- **Final Exercise**: Create a Deep Wiki research agent using MCP
